 ...
 */
$messages['ast'] = array(
	'vipstest' => "Páxina de pruebes d'escaláu VIPS",
	'vipsscaler-desc' => 'Crear miniatures usando VIPS',
	'vipsscaler-invalid-file' => "Nun pudo procesase'l ficheru solicitáu. Compruebe qu'esista nesta wiki.",
	'vipsscaler-invalid-width' => "L'anchu de la miniatura tien de ser mayor que cero y non mayor que l'anchu del ficheru.",
	'vipsscaler-invalid-sharpen' => 'El valor del enfoque tendría de ser un númberu mayor que cero y menor que cinco.',
	'vipsscaler-thumb-error' => 'VIPS nun pue xenerar una miniatura colos parámetros daos.',
	'vipsscaler-form-legend' => 'Escaláu VIPS',
	'vipsscaler-form-width' => 'Anchu de la miniatura:',
	'vipsscaler-form-file' => "Ficheru d'esta wiki:",
	'vipsscaler-form-sharpen-radius' => "Cantidá d'enfoque:",
	'vipsscaler-form-bilinear' => 'Escaláu billinial',
	'vipsscaler-form-submit' => 'Xenerar miniatures',
	'vipsscaler-thumbs-legend' => 'Miniatures xeneraes',
	'vipsscaler-thumbs-help' => "La miniatura que s'amuesa más abaxo xeneróse col escalador predetermináu. Mueva'l mur sobro la miniatura pa comparala cola xenerada por VIPS. Alternativamente, pue marcar / desmarcar el caxellu de comprobación de más abaxo pa cambiar ente les miniatures.",
	'vipsscaler-thumbs-switch-label' => 'Calque pa cambiar ente la salida del escaláu predeterminada y la de VIPS.',
	'vipsscaler-default-thumb' => 'Miniatura xenerada col escalador predetermináu',
	'vipsscaler-vips-thumb' => 'Miniatura xenerada con VIPS',
	'vipsscaler-show-both' => 'Ver les dos miniatures',
	'vipsscaler-show-default' => 'Ver sólo la miniatura predeterminada',
	'vipsscaler-show-vips' => 'Ver sólo la miniatura de VIPS',
	'right-vipsscaler-test' => 'Usar la interfaz de prueba del escaláu VIPS [[Special:VipsTest]]',
);
...
$messages['be-tarask'] = array(
	...
	'vipsscaler-invalid-width' => 'Шырыня мініятуры мусіць быць большай за нуль і меншай за шырыню файла.',
	'vipsscaler-invalid-sharpen' => 'Ступень рэзкасьці мусіць быць лікам ад нуля да пяці.',
	'vipsscaler-thumb-error' => 'VIPS ня змог стварыць мініятуру з дадзенымі парамэтрамі.',
	'vipsscaler-form-legend' => 'Маштабаваньне VIPS',
	'vipsscaler-form-width' => 'Шырыня мініятуры:',
	'vipsscaler-form-file' => 'Файл у {{GRAMMAR:месны|{{SITENAME}}}}:',
	'vipsscaler-form-sharpen-radius' => 'Ступень рэзкасьці:',
	'vipsscaler-form-bilinear' => 'Білінейнае маштабаваньне',
	'vipsscaler-form-submit' => 'Стварыць мініятуры',
	'vipsscaler-thumbs-legend' => 'Створаныя мініятуры',
	'vipsscaler-thumbs-help' => 'Мініятура, паказаная ніжэй, была створаная дапомным маштабавальнікам. Навядзіце маш на мініятуру, каб параўнаць яе з мініятуранай, якую стварыў VIPS. Вы можаце таксама паставіць (прыбраць) птушку ніжэй, каб пераключыцца паміж мініятурамі.',
	'vipsscaler-thumbs-switch-label' => 'Пстрыкніце, каб пераключыцца паміж вынікамі звычайнага маштабавальніка і маштабавальніка VIPS.',
	'vipsscaler-default-thumb' => 'Мініятура, створаная дапомным маштабавальнікам',
	'vipsscaler-vips-thumb' => 'Мініятура, створаная маштабавальнікам VIPS',
	'vipsscaler-show-both' => 'Паказаць абедзьве мініятуры',
	'vipsscaler-show-default' => 'Паказаць толькі дапомную мініятуру',
	'vipsscaler-show-vips' => 'Паказаць толькі мініятуру VIPS',
	'right-vipsscaler-test' => 'карыстаньне інтэрфэйсам тэставаньня маштабаваньня VIPS [[Special:VipsTest]]',
);
 ...
 */
$messages['es'] = array(
	'vipstest' => 'Página de pruebas de escalado VIPS',
	...
	'vipsscaler-invalid-width' => 'La anchura de la miniatura debe ser mayor que cero y no mayor que la anchura del archivo.',
	'vipsscaler-invalid-sharpen' => 'El valor del enfoque debería ser un número mayor que cero y menor que cinco.',
	'vipsscaler-thumb-error' => 'VIPS no pudo generar una miniatura con los parámetros dados.',
	'vipsscaler-form-legend' => 'Escalado VIPS',
	'vipsscaler-form-width' => 'Ancho de la miniatura:',
	'vipsscaler-form-file' => 'Archivo en esta wiki:',
	'vipsscaler-form-sharpen-radius' => 'Cantidad de enfoque:',
	'vipsscaler-form-bilinear' => 'Escalado bilineal',
	'vipsscaler-form-submit' => 'Generar miniaturas',
	'vipsscaler-thumbs-legend' => 'Miniaturas generadas',
	'vipsscaler-thumbs-help' => 'La miniatura que se muestra a continuación se generó con el escalador predeterminado. Mueva el ratón sobre la miniatura para compararla con la generada por VIPS. Alternativamente, puede marcar / desmarcar con el ratón la casilla de verificación que aparece a continuación para cambiar entre las miniaturas.',
	'vipsscaler-thumbs-switch-label' => 'Haga clic para cambiar entre el resultado del escalado predeterminado y el escalado VIPS.',
	'vipsscaler-default-thumb' => 'Miniatura generada con el escalador predeterminado',
	'vipsscaler-vips-thumb' => 'Miniatura generada con VIPS',
	'vipsscaler-show-both' => 'Muestra ambas miniaturas',
	'vipsscaler-show-default' => 'Mostrar sólo miniatura predeterminada',
	'vipsscaler-show-vips' => 'Mostrar sólo miniatura VIPS',
...
$messages['ja'] = array(
	...
	'vipsscaler-invalid-sharpen' => '鮮鋭化量はゼロより大きく5より小さい数値でなくてはなりません。',
	'vipsscaler-thumb-error' => 'VIPS は指定されたパラメーターではサムネイルを生成できませんでした。',
	'vipsscaler-form-legend' => 'VIPS 拡大/縮小',
	'vipsscaler-form-width' => 'サムネイルの幅:',
	'vipsscaler-form-file' => 'このウィキのファイル:',
	'vipsscaler-form-sharpen-radius' => '鮮鋭化量:',
	'vipsscaler-form-bilinear' => 'バイリニア補間',
	'vipsscaler-form-submit' => 'サムネイルを生成',
	'vipsscaler-thumbs-legend' => '生成されたサムネイル',
	'vipsscaler-thumbs-help' => '以下のサムネイルはデフォルトの拡大/縮小機能で生成されました。マウスをサムネイルの上に移動すると、VIP によって生成されたものと比較できます。または、下のチェックボックスをクリックしてサムネイルを切り替えることができます。',
	'vipsscaler-thumbs-switch-label' => 'クリックして拡大/縮小結果をデフォルトと VIPS のもので切り替える。',
	'vipsscaler-default-thumb' => 'デフォルトの拡大/縮小機能で生成されたサムネイル',
	'vipsscaler-vips-thumb' => 'VIPS で生成されたサムネイル',
...
$messages['ko'] = array(
	...
	'vipsscaler-thumb-error' => 'VIPS는 변수가 주어진 섬네일을 만들 수 없습니다.',
	'vipsscaler-form-legend' => 'VIPS 스케일링',
	'vipsscaler-form-width' => '섬네일 너비:',
	'vipsscaler-form-file' => '이 위키에 있는 파일:',
	'vipsscaler-form-sharpen-radius' => '선명한 양:',
	'vipsscaler-form-bilinear' => '이중 선형 스케일링',
	'vipsscaler-form-submit' => '섬네일 만들기',
	'vipsscaler-thumbs-legend' => '만들어진 섬네일',
	'vipsscaler-thumbs-help' => '아래 섬네일은 기본 스케일러로 만들었습니다. VIPS에 의해 만든 하나와 이를 비교하려면 섬네일 위에 마우스를 움직이세요. 또는 섬네일 사이를 전환하려면 아래 확인란을 클릭하거나 하지 않을 수 있습니다.',
	'vipsscaler-thumbs-switch-label' => '기본 스케일링 출력과 VIPS 스케일링 출력 사이를 전환하려면 클릭하세요.',
	'vipsscaler-default-thumb' => '기본 스케일러로 만든 섬네일',
	'vipsscaler-vips-thumb' => 'VIPS로 만든 섬네일',
	'vipsscaler-show-both' => '모든 섬네일 보기',
	'vipsscaler-show-default' => '기본 섬네일만 보기',
	'vipsscaler-show-vips' => 'VIPS 섬네일만 보기',
	'right-vipsscaler-test' => 'VIPS 스케일링 테스트 인터페이스 [[Special:VipsTest]] 사용',
);
...
$messages['ml'] = array(
	...
	'vipsscaler-desc' => 'വിപ്സ് (VIPS) ഉപയോഗിച്ച് ലഘുചിത്രങ്ങൾ സൃഷ്ടിക്കുക',
	'vipsscaler-invalid-file' => 'ആവശ്യപ്പെട്ട പ്രമാണം കൈകാര്യം ചെയ്യാൻ കഴിഞ്ഞില്ല. അത് വിക്കിയിൽ നിലവിലുണ്ടോയെന്ന് പരിശോധിക്കുക.',
	'vipsscaler-invalid-width' => 'ലഘുചിത്രത്തിന്റെ വീതി പൂജ്യം ആയിരിക്കാനും പ്രമാണത്തിന്റെ വീതിയേക്കാൾ കൂടുതൽ ആയിരിക്കാനും പാടില്ല.',
	'vipsscaler-invalid-sharpen' => 'തീക്ഷ്ണമാക്കൽ വില, പൂജ്യത്തിലും വലുതും അഞ്ചിൽ ചെറുതുമായ ഒരു സംഖ്യ ആയിരിക്കണം.',
	'vipsscaler-thumb-error' => 'നൽകിയിരിക്കുന്ന ചരങ്ങൾ ഉപയോഗിച്ച് ലഘുചിത്രം സൃഷ്ടിക്കാൻ വിപ്സിനു (VIPS) കഴിയില്ല.',
	'vipsscaler-form-legend' => 'വിപ്സ് അളവ് മാറ്റൽ',
	'vipsscaler-form-width' => 'ലഘുചിത്രത്തിന്റെ വീതി:',
	'vipsscaler-form-file' => 'ഈ വിക്കിയിലെ പ്രമാണം:',
	'vipsscaler-form-sharpen-radius' => 'തീക്ഷ്ണമാക്കൽ വില:',
	'vipsscaler-form-bilinear' => 'ദ്വിദിശാ അളവ് മാറ്റൽ',
	'vipsscaler-form-submit' => 'ലഘുചിത്രങ്ങൾ സൃഷ്ടിക്കുക',
	'vipsscaler-thumbs-legend' => 'സൃഷ്ടിക്കപ്പെട്ട ലഘുചിത്രങ്ങൾ',
	'vipsscaler-thumbs-help' => 'സ്വതേയുള്ള അളവ് മാറ്റൽ സൗകര്യമുപയോഗിച്ച് സൃഷ്ടിച്ച ലഘുചിത്രമാണ് താഴെക്കൊടുത്തിരിക്കുന്നത്. വിപ്സ് (VIPS) ഉപയോഗിച്ച് സൃഷ്ടിച്ച ലഘുചിത്രവുമായി താരതമ്യപ്പെടുത്തി നോക്കാൻ ലഘുചിത്രത്തിനു മുകളിലൂടെ മൗസ് ഓടിക്കുക. ചെക്ക് ബോക്സിൽ ശരി ചേർത്തും നീക്കം ചെയ്തും ലഘുചിത്രങ്ങൾ മാറ്റി കാണാവുന്നതാണ്.',
	'vipsscaler-thumbs-switch-label' => 'സ്വതേയുള്ളതും വിപ്സ് (VIPS) ഉപയോഗിച്ചുള്ളതുമായ ഔട്ട്പുട്ടുകൾ തമ്മിൽ മാറ്റാൻ ഞെക്കുക.',
	'vipsscaler-default-thumb' => 'സ്വതേയുള്ള അളവ് മാറ്റൽ സൗകര്യം ഉപയോഗിച്ചുള്ള ലഘുചിത്രം',
	'vipsscaler-vips-thumb' => 'വിപ്സ് (VIPS) ഉപയോഗിച്ചുള്ള ലഘുചിത്രം',
	'vipsscaler-show-both' => 'രണ്ട് ലഘുചിത്രങ്ങളും പ്രദർശിപ്പിക്കുക',
	'vipsscaler-show-default' => 'സ്വതേയുള്ള ലഘുചിത്രം മാത്രം പ്രദർശിപ്പിക്കുക',
	'vipsscaler-show-vips' => 'വിപ്സ് (VIPS) ലഘുചിത്രം മാത്രം പ്രദർശിപ്പിക്കുക',
	'right-vipsscaler-test' => 'വിപ്സ് (VIPS) അളവ് മാറ്റൽ [[Special:VipsTest|പരീക്ഷണ കേന്ദ്രം ഉപയോഗിക്കുക]].',
);
 ...
 */
$messages['nn'] = array(
	'vipstest' => 'Teststide for VIPS-skalering',
	'vipsscaler-desc' => 'Skap miniatyrbilete ved hjelp av VIPS',
	'vipsscaler-invalid-file' => 'Kunne ikkje handsama den førespurde fila. Sjå at ho finst på denne wikien.',
	'vipsscaler-invalid-width' => 'Breidda på miniatyrbiletet skal vera større enn null og ikkje større enn filbreidda.',
	'vipsscaler-thumb-error' => 'VIPS kunne ikkje skapa ein miniatyr med dei gjevne parametrane.',
	'vipsscaler-form-legend' => 'VIPS-skalering',
	'vipsscaler-form-width' => 'Miniatyrstorleik:',
	'vipsscaler-form-file' => 'Fil på wikien:',
	'vipsscaler-form-sharpen-radius' => 'Grad av skarpgjering:',
	'vipsscaler-form-bilinear' => 'Bilinær skalering',
	'vipsscaler-form-submit' => 'Skap miniatyrbilete',
	'vipsscaler-thumbs-legend' => 'Skapa miniatyrbilete',
	'vipsscaler-thumbs-switch-label' => 'Klikk for å byta mellom utdata frå standard skalering og VIPS-skalering.',
	'vipsscaler-default-thumb' => 'Minatyr skapa med standard skalering',
	'vipsscaler-vips-thumb' => 'Miniatyr skapa med VIPS',
	'vipsscaler-show-both' => 'Vis båe miniatyrane',
	'vipsscaler-show-default' => 'Vis berre standard minatyr',
	'vipsscaler-show-vips' => 'Vis berre VIPS-miniatyr',
...
$messages['roa-tara'] = array(
	...
	'vipsscaler-invalid-sharpen' => "'U valore d'u tagghie avessa essere 'nu numere cchiù granne de zero e cchiù peccinne de cinghe.",
	'vipsscaler-thumb-error' => "VIPS non ge pò generà 'na miniature ca le parametre date.",
	...
	'vipsscaler-thumbs-help' => "'A miniature ca ste 'ndruche aqquàò sotte ha state generate cu 'na scale de base. Spuèste 'u sciorge tune sus 'a miniature pe combrondà cu une generate da VIPS. In alternative, tu puè mettere o luà 'u segne aqquà sotte pe cangià 'mbrà le miniature.",
	'vipsscaler-thumbs-switch-label' => "Cazze pe passà da 'a scale de base a quelle de VIPS pu resultate.",
...
$messages['sv'] = array(
	...
	'vipsscaler-thumb-error' => 'VIPS kunde inte skapa en miniatyr med de givna parametrarna.',
 ...
 */
$messages['tl'] = array(
	'vipstest' => 'Pahinang pangsubok ng paninimbang sa sukat ng VIPS',
	'vipsscaler-desc' => 'Lumikha ng mga kagyat na ginagamit ang VIPS',
	'vipsscaler-invalid-file' => 'Hindi maipruseso ang hinihiling na talaksan. Siyasatin na umiiral ito sa wiking ito.',
	'vipsscaler-invalid-width' => 'Ang lapad ng kagyat ay dapat na mas malaki kaysa sa sero at hindi mas malaki kaysa sa lapad ng talaksan.',
	'vipsscaler-invalid-sharpen' => 'Ang dami ng pagpapatalas ay dapat na maging isang bilang na mas malaki kaysa sa sero at mas maliit kaysa sa lima.',
	'vipsscaler-thumb-error' => 'Ang VIPS ay hindi makalikha ng isang kagyat sa pamamagitan ng ibinigay na mga parametro.',
	'vipsscaler-form-legend' => 'Panimbangan ng sukat ng VIPS',
	'vipsscaler-form-width' => 'Lapad ng kagyat:',
	'vipsscaler-form-file' => 'Isalansan sa wiking ito:',
	'vipsscaler-form-sharpen-radius' => 'Dami ng pagpapatalas:',
	'vipsscaler-form-bilinear' => 'Paninimbang ng sukat na pangdalawahang guhit',
	'vipsscaler-form-submit' => 'Lumikha ng mga kagyat',
	'vipsscaler-thumbs-legend' => 'Nalikhang mga kagyat',
	'vipsscaler-thumbs-help' => 'Ang kagyat na ipinapakita sa ibaba ay nilikha sa pamamagitan ng likas na nakatakdang pampaninimbang ng sukat. Pagalawin ang iyong aparatong bubwit sa ibabaw ng kagyat upang maihambing ito sa isang nalikha ng VIPS. O kaya, maaari mong pindutin / huwag nang pindutin ang kahong malalagyan ng tsek na nasa ibaba upang makapagpalipat-lipat sa pagitan ng mga kagyat.',
	'vipsscaler-thumbs-switch-label' => 'Lagitikin upang makapagpalipat-lipat sa pagitan ng kinalalabasan ng likas na nakatakda at ng paninimbang ng VIPS sa sukat.',
	'vipsscaler-default-thumb' => 'Kagyat na nalikha sa pamamagitan ng likas na nakatakdang pantimbang ng sukat',
	'vipsscaler-vips-thumb' => 'Kagyat na nalikha sa pamamagitan ng VIPS',
	'vipsscaler-show-both' => 'Ipakita kapwa ang mga kagyat',
	'vipsscaler-show-default' => 'Ipakita lamang ang likas na nakatakdang kagyat',
	'vipsscaler-show-vips' => 'Ipakita ang kagyat ng VIPS lamang',
	'right-vipsscaler-test' => 'Gamitin ang ugnayang-mukha na [[Special:VipsTest|Natatangi:Pagsubok ng VIPS]] ng pangsubok sa paninimbang ng sukat ng VIPS',
);
 ...
 */
$messages['tr'] = array(
	'vipstest' => 'VIPS ölçekleme test sayfası',
	'vipsscaler-desc' => 'VIPS kullanarak küçük resimler oluşturun',
	'vipsscaler-invalid-file' => 'İstenilen dosyaya işlem uygulanamadı. Dosyanın bu viki üzerinde olduğundan emin olun.',
	'vipsscaler-invalid-width' => 'Küçük resim genişliği sıfırdan büyük olmalı, dosya genişliğinden ise daha büyük olmamalıdır.',
	'vipsscaler-invalid-sharpen' => 'Keskinleştirme oranı sıfırdan büyük olmalı ve beşten daha küçük bir sayı olmamalıdır.',
	'vipsscaler-thumb-error' => 'VIPS verilen değerler ile bir küçük resim oluşturamadı.',
	'vipsscaler-form-legend' => 'VIPS ölçekleme',
	'vipsscaler-form-width' => 'Küçük resim genişliği:',
	'vipsscaler-form-file' => 'Bu viki üzerindeki dosya:',
	'vipsscaler-form-sharpen-radius' => 'Keskinleştirme oranı:',
	'vipsscaler-form-bilinear' => 'İki çizgili ölçekleme',
	'vipsscaler-form-submit' => 'Küçük resim oluşturma',
	'vipsscaler-thumbs-legend' => 'Küçük resim oluşturma',
	'vipsscaler-thumbs-help' => 'Aşağıda gösterilen küçük resim varsayılan ölçekler ile oluşturuldu. VIPS tarafından oluşturulan küçük resmi karşılaştırmak için imleci üzerinde gezdirin. Alternatif olarak, küçük resim arasında geçiş yapmak için onay kutusunu tıklayın.',
	'vipsscaler-thumbs-switch-label' => 'Varsayılan ve VIPS ölçekleme sonucu arasında geçiş yapmak için tıklayın.',
	'vipsscaler-default-thumb' => 'Varsayılan ölçekler ile oluşturulan küçük resim',
	'vipsscaler-vips-thumb' => 'VIPS ile oluşturulan küçük resim',
	'vipsscaler-show-both' => 'Her iki küçük resmi göster',
	'vipsscaler-show-default' => 'Yalnızca varsayılan küçük resmi göster',
	'vipsscaler-show-vips' => 'Yalnızca VIPS küçük resmini göster',
	'right-vipsscaler-test' => 'VIPS ölçekleme test arayüzünü kullanım [[Special:VipsTest|Özel:VipsTest]]',
);
